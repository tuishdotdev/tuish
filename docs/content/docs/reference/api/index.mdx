...
View the full OpenAPI spec here: [API Reference](/docs/reference/api/reference).
...
- [Checkout API](/docs/reference/api/checkout) - Request/response details for checkout
- [Authentication API](/docs/reference/api/authentication) - OTP-based customer login
- [Licenses API](/docs/reference/api/licenses) - License validation and format
- [Complete Integration Guide](/docs/tutorials/complete-integration-flow) - End-to-end walkthrough
