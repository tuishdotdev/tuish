...
View the full OpenAPI spec here: [API Reference](/docs/api/reference).
...
Tip: add `--json` to CLI commands for machine-readable output.
See [CLI docs](/docs/cli) for details.
